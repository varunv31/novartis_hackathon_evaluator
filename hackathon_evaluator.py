...
class NovartisHackathonEvaluator:
    ...
    def compute_task2_score(self, task2_submission_path):
        ...
        # Compute Compound Column for both ground truth and participant submission
        ...
        submitted_values = set(participant_submission["compound_column"].tolist())

        mismatches = expected_values - submitted_values

        if len(mismatches) != 0:
            print("The participant needs to rework on the solution. There are {} lines missing. ".format(len(mismatches)))
    ...
    def compute_task3_score(self, task3_submission_path):
        ...
        df_cluster = participant_submission.drop(['Hospital_ID','Market_Cluster'], axis=1)
    ...
    def evaluate(self, submission_folder):
        ...
        weighted_score = score_1_weighted + score_2_weighted + score_3_weighted + score_4_weighted + score_5_weighted
